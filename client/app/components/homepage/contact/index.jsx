...
export default function ContactSection() {
  ...
  // Social links from personalData
  const socials = [
  ...
  return (
    <div
      id="contact"
      className="group relative bg-[#0e1129] transition duration-300 ease-in-out text-white py-20 px-6 md:px-24 overflow-hidden border border-violet-800 rounded-2xl shadow-[0_0_50px_#281b89aa]"
    >
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          <p className="text-gray-400">
            ...
            mind, or just want to say hello, I'd love to hear from you. Let's
          ...
          <div className="space-y-6 text-gray-300">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">{personalData.email}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">{personalData.phone}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">{personalData.address}</div>
              </div>
            </div>
          </div>
